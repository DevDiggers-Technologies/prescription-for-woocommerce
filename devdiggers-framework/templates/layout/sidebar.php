...
<div class="ddfw-template-container">
	...
	if ( ! empty( $tabs ) && is_array( $tabs ) ) {
		...
		<button class="ddfw-mobile-settings-toggle" type="button" aria-label="<?php esc_attr_e( 'Toggle Settings', 'devdiggers-prescription-for-woocommerce' ); ?>">
		...
		<nav class="ddfw-left-tab-wrapper">
			...
			<button class="ddfw-mobile-settings-close" type="button" aria-label="<?php esc_attr_e( 'Close Settings', 'devdiggers-prescription-for-woocommerce' ); ?>">
